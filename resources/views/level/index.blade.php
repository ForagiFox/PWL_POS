...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-tools">
            <a href="{{url('user/create')}}" class="btn btn-sm btm-primary mt-1">Tambah</a>
        </div>
    </div>
        <div class="card-body">
            @if (session('success'))
            ...
            </div>        <table class="table table-bordered table-striped table-hover table-sm" id="table_user">
            <thead>
            <tr>
            <th>ID</th>
            <th>Username</th>
